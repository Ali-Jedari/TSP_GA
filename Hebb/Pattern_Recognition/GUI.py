...
# Form implementation generated from reading ui file '/home/ali/Documents/Computational Intelligence/tazaGUI.ui'
#
...
import XO_Classification_Hebb as xo
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.resultButton.setStyleSheet("background-color: rgb(186, 189, 182);")
        ...
        self.resetButton.setStyleSheet("background-color: rgb(186, 189, 182);")
    ...
    def getResult(self):
        ...
        if self.Button_0.styleSheet().__contains__("rgb(0,0,0)"):
            grid[0][0] = 1
        else:
            grid[0][0] = -1
        if self.Button_1.styleSheet().__contains__("rgb(0,0,0)"):
            grid[0][1] = 1
        else:
            grid[0][1] = -1
        if self.Button_2.styleSheet().__contains__("rgb(0,0,0)"):
            grid[0][2] = 1
        else:
            grid[0][2] = -1
        if self.Button_3.styleSheet().__contains__("rgb(0,0,0)"):
            grid[0][3] = 1
        else:
            grid[0][3] = -1
        if self.Button_4.styleSheet().__contains__("rgb(0,0,0)"):
            grid[0][4] = 1
        else:
            grid[0][4] = -1
        if self.Button_5.styleSheet().__contains__("rgb(0,0,0)"):
            grid[1][0] = 1
        else:
            grid[1][0] = -1
        if self.Button_6.styleSheet().__contains__("rgb(0,0,0)"):
            grid[1][1] = 1
        else:
            grid[1][1] = -1
        if self.Button_7.styleSheet().__contains__("rgb(0,0,0)"):
            grid[1][2] = 1
        else:
            grid[1][2] = -1
        if self.Button_8.styleSheet().__contains__("rgb(0,0,0)"):
            grid[1][3] = 1
        else:
            grid[1][3] = -1
        if self.Button_9.styleSheet().__contains__("rgb(0,0,0)"):
            grid[1][4] = 1
        else:
            grid[1][4] = -1
        if self.Button_10.styleSheet().__contains__("rgb(0,0,0)"):
            grid[2][0] = 1
        else:
            grid[2][0] = -1
        if self.Button_11.styleSheet().__contains__("rgb(0,0,0)"):
            grid[2][1] = 1
        else:
            grid[2][1] = -1
        if self.Button_12.styleSheet().__contains__("rgb(0,0,0)"):
            grid[2][2] = 1
        else:
            grid[2][2] = -1
        if self.Button_13.styleSheet().__contains__("rgb(0,0,0)"):
            grid[2][3] = 1
        else:
            grid[2][3] = -1
        if self.Button_14.styleSheet().__contains__("rgb(0,0,0)"):
            grid[2][4] = 1
        else:
            grid[2][4] = -1
        if self.Button_15.styleSheet().__contains__("rgb(0,0,0)"):
            grid[3][0] = 1
        else:
            grid[3][0] = -1
        if self.Button_16.styleSheet().__contains__("rgb(0,0,0)"):
            grid[3][1] = 1
        else:
            grid[3][1] = -1
        if self.Button_17.styleSheet().__contains__("rgb(0,0,0)"):
            grid[3][2] = 1
        else:
            grid[3][2] = -1
        if self.Button_18.styleSheet().__contains__("rgb(0,0,0)"):
            grid[3][3] = 1
        else:
            grid[3][3] = -1
        if self.Button_19.styleSheet().__contains__("rgb(0,0,0)"):
            grid[3][4] = 1
        else:
            grid[3][4] = -1
        if self.Button_20.styleSheet().__contains__("rgb(0,0,0)"):
            grid[4][0] = 1
        else:
            grid[4][0] = -1
        if self.Button_21.styleSheet().__contains__("rgb(0,0,0)"):
            grid[4][1] = 1
        else:
            grid[4][1] = -1
        if self.Button_22.styleSheet().__contains__("rgb(0,0,0)"):
            grid[4][2] = 1
        else:
            grid[4][2] = -1
        if self.Button_23.styleSheet().__contains__("rgb(0,0,0)"):
            grid[4][3] = 1
        else:
            grid[4][3] = -1
        if self.Button_24.styleSheet().__contains__("rgb(0,0,0)"):
            grid[4][4] = 1
        else:
            grid[4][4] = -1
